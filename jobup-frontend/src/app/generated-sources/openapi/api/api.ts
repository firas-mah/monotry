...
export const APIS = [AuthenticationService, ChatControllerService, FileUploadService, JobDealControllerService, JobPostControllerService, NotificationControllerService, ProposalControllerService, RatingControllerService, WorkerControllerService];
